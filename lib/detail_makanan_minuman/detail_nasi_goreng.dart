...
class DetailNasiGoreng extends StatefulWidget {
  const DetailNasiGoreng({super.key});

  @override
  State<DetailNasiGoreng> createState() => _DetailNasiGorengState();
}
...
class _DetailNasiGorengState extends State<DetailNasiGoreng> {
  ...
  static const String namaMenu = "Nasi Goreng Spesial";
  static const String deskripsi =
      "Nasi Goreng + Telor Mata Sapi + Lalapan + Sayuran + Kerupuk + Bakso + Sosis (level 1-5).";
  static const int priceValue = 27000;
  static const String hargaTetap = "Rp 27.000";
  static const String gambarPath = "assets/nasi_goreng.jpg";
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return Container(
                        ...
                        child: Text(
                          "Gambar Nasi Goreng tidak ditemukan",
